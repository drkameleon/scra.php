 ...
 */
require_once 'libraries/console/CommandLine/Exception.php';
require_once 'libraries/console/CommandLine/Outputter/Default.php';
require_once 'libraries/console/CommandLine/Renderer/Default.php';
require_once 'libraries/console/CommandLine/MessageProvider/Default.php';
...
class Console_CommandLine
{
    ...
    {
        include_once 'libraries/console/CommandLine/XmlParser.php';
    ...
    public function addArgument($name, $params = array())
    {
        if ($name instanceof Console_CommandLine_Argument) {
            ...
            include_once 'libraries/console/CommandLine/Argument.php';
    ...
    public function addCommand($name, $params = array())
    {
        if ($name instanceof Console_CommandLine_Command) {
            ...
            include_once 'libraries/console/CommandLine/Command.php';
            $params['name'] = $name;
    ...
    {
        include_once 'libraries/console/CommandLine/Option.php';
     ...
     *
     * require_once 'libraries/console/CommandLine.php';
     * require_once 'libraries/console/CommandLine/Action.php';
     *
    ...
    public function parse($userArgc=null, $userArgv=null)
    {
        ...
        include_once 'libraries/console/CommandLine/Result.php';
